# Django settings for cmsc424Site project.
...
DATABASES = {
    'default': {
        ...
        'NAME': PATH_TO_FILE + '/finance.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'p65n0l9j=9khci_n-dex0l#1q&bkx9h!7im&l^z#px3(kcpgbu'
...
ROOT_URLCONF = 'cmsc424Site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cmsc424Site.wsgi.application'
